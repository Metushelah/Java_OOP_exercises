...
public class Variable{
    ...
    /*
     * in this verifier we don't really care for the value therefore @isAssigned is a boolean.
     */
     ...
     * @throws UnassignedFinalException when trying to make a final variable without assigning it.
     * @throws IllegalValueException when providing an illegal value.
     */
     ...
     * @throws IllegalValueException when an illegal value to variable provided.
     */

...
/**
 * This class represents methods that can be implemented in Sjava. Such methods have a signiture and
...
public class Method {
    ...
    /** main constructor for methods. We recieve a Variable array because inside methods those count
     *  against other local variables in the scope.
     *  @param name a string with the method name.
     *  @param parameters a Variable array with the parameters from the signiture.
    ...
    /**
     *  Checks if a method call is compatiable to method signiture
     *  @param arguments the list of variables to compare to the method signiture.
     *  @return True of False if the method call is according to signiture.
     */
     ...
     * @return Variable array holding the parameters specified in the method signiture.
     */
